...
static const unsigned int _StringsDefault0[] =
{
  ...
  0x0758F9CA, 0x00831C00, 0x082C0C68, 0x31C4CA40, 0xE4CE6A00, 0x43221128, 0x423D1287,
  0xA4A0030C, 0x434C8C44, 0x1418BD1E, 0x00A4CCC0, 0x0A643A50, 0x89D16434, 0x84DE6B0E,
  0x002C120A, 0x36CE79A0, 0x2702E89D, 0x11069D96, 0x64BA9C2A, 0x56285A62, 0x88E00237,
  0x8F530004, 0x9C324B18, 0x45AF7489, 0x8C006D86, 0x23118864, 0x25158B63, 0xC0088CB6,
  0x16CAD6E3, 0xF3548E35, 0x8F43ACB3, 0x5C3A431A, 0x45A4F94C, 0x3EBF79C7, 0xAF266876,
  0x870EC4C6, 0x50C99C7C, 0x47DB0007, 0xD9BD575C, 0x80CE2716, 0x00000000
};
...
static const XColor _Const0003 = { 0x00, 0x00, 0x00, 0x00 };
static const XStringRes _Const0004 = { _StringsDefault0, 0x002D };
static const XStringRes _Const0005 = { _StringsDefault0, 0x0061 };
...
const XPoint EwScreenSize = { 640, 480 };
  ...
  aOffset, XInt32 aOpacity, XBool aBlend )
{
  ...
  if ( !fullScreenUpdate )
    ...
    aClip, aOffset ), _this->Super2.Bounds.Point1 ), _Const0003, _Const0003, _Const0003, 
    _Const0003, 0 );
  ...
  for ( i = 0; i < 10; i = i + 1 )
    if ( _this->cursorTargetView[ EwCheckIndex( i, 10 )] != 0 )
    {
      ...
      else
      {
        ...
        )], _this->cursorLastPos[ EwCheckIndex( i, 10 )], _this->cursorFirstPos[ 
        EwCheckIndex( i, 10 )])));
        found = 1;
      }
    }
